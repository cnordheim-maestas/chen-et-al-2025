...
## 2b Stats
Most appropriate comaprison for study design: 
day*microbes*water_treatment
...
```{r}
# build model
mod3 <- aov(log_adh_plus_sup ~ day*microbes*water_treatment,
  data = pw_noday0)
...
# comparisons
em <- emmeans(mod3, ~ day * microbes * TB * PW)
...
Note: Not perfectly homoskedstic...
...
This is nearly identical, same AIC, I think needlessly complex, might be kinda the same model??
