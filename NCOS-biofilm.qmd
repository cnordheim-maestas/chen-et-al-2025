...
# 3b Aquatic environmental biofilm on Bd growth (previously mislabeled as 4b):

All microbe-depleted, NO microbe+ treatment (from 3b figure legend)
...
# 4b Monolayer biofilm on Bd growth (previously mislabeled as 3b):
...
monolayer_summary %>% 
  ...
  labs(x = "Day",
       ...
       caption = "supernatant plus adherent visualized here\nNCOS data from tab called fig 3b but I think it was supposed to be 4b") +
