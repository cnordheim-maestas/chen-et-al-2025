...
myCustomTheme <- function() {
  theme_light() +
    theme(axis.text = element_text(size = 7, family = "Helvetica", color = "black"),
          ...
          axis.ticks = element_line(color = "grey"),   # Keep tick markers
          strip.text = element_text(size = 7, face = "bold", family = "Helvetica", color = "black"), # Set strip text style
          strip.background = element_rect(fill = "white", color = "grey")  # Set strip background to white, outline grey
    )
}
```
...
#ggsave("2a_2b.pdf", plot = fig2, width = 14, height = 5, dpi = 1000) # change to width 88 mm

ggsave("hhhh.pdf", plot = fig2, width = 3.46, height = 5)

# instead export 2a and 2b
