...
pairwise_day_2b_df <- as.data.frame(pairwise_day_2b$emmeans)
ggplot(pairwise_day_2b_df, aes(x = day, y = emmean)) +
  geom_point(size = 3) +
  geom_errorbar(aes(ymin = asymp.LCL, ymax = asymp.UCL), width = 0.2) +
  scale_y_continuous(limits = c(8, 16), breaks = seq(8, 16, by = 2)) +
  labs(title = "Pairwise Comparisons: Day", x = "Day", y = "Estimated Marginal Means") +
  theme_minimal()
```
...
#ggsave("2a_updated.pdf", plot = fig_2a, width = 3.46, height = 3.46)
...
#    coord_cartesian(ylim = c(10, 1e8)) + # Set y-axis range from 10 to 10^8
#     facet_wrap(~day, labeller = labeller(day = c("Day_1" = "Day 1",
#                                                     "Day_7" = "Day 7")))+
#   
#   scale_fill_manual(values = c("40um_filter" = with_microbes_40_color, 
...
#ggsave("2a.pdf", plot = fig_2a, width = 3.46, height = 3.46)

#ggsave("fig_2a_RS.pdf", plot = fig_2a_RS, width = 3.46, height = 3.46)


#ggsave("2b.pdf", plot = fig2B, width = 3.46, height = 3.46)
...
#ggsave("SI_2b.pdf", plot = pairwise_cld_2b, width = 7.09, height = 3.46)

cld_water_thirdorder_2b 

#ggsave("SI_2b_thirdorder.pdf", plot = cld_water_thirdorder_2b , width = 7.09, height = 3.46)
```
...
ggsave("SI_2b_updated.pdf", plot = pairwise_cld_2b, width = 7.09, height = 3.46)
...
ggsave("SI_2b_thirdorder_updated.pdf", plot = cld_water_thirdorder_2b , width = 7.09, height = 3.46)

```



## 2a Raw EB data barplot
...
ggsave("SI_2a.pdf", plot = fig_SI2A, width = 7.09, height = 3.46)
```
