...
ab2 <- all_parts2 %>% 
  ...
  scale_x_discrete (labels= c("PW 0.22um" = "EB PW - MO"
                              ...
                              "Field bf 0.22" = "EB Biofilm",
                              "NCOS AE 0.22um" = "SB Biofilm")) +
  ggtitle("Option 1: no color, no facet")
...
ab2 <- all_parts2 %>% 
  mutate(medium = case_when(
   ...
   ggplot(aes(y= rate_loss, x = treatment, fill = site)) +
    geom_boxplot() +
  geom_jitter(alpha = 0.5, width = 0.05) +
    theme_classic() +
   scale_fill_manual(values = c("East Bay" = "orange",
                                  "Santa Barbara" = "pink")) +
  facet_wrap(~medium, scales = "free_x",
             labeller = labeller(medium = c("PW" = "Pond Water + Microbes",
                                            "Field bf" = "AE Biofilm"))) +
   theme(legend.position = "none",
         strip.text = element_text(face="bold"),
         axis.title = element_text(face = "bold")) +
  ...
  scale_x_discrete (labels= c("PW 0.22um" = "EB PW - MO"
                              ...
                              "Field bf 0.22" = "EB Biofilm",
                              "NCOS AE 0.22um" = "SB Biofilm")) +
  ggtitle("Option 2: colored by site, facet by type")
