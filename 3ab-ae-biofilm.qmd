...
# 3a alone
ggsave("3a_updated.pdf", plot = fig_3a, width = 3.46, height = 3.46)
```

3A: AE Biofilm Renwei scale

```{r}
fig_3a_RS_boxplot <- eb_ae_bf_only  %>%
ggplot(aes(y= bd_qty, x = day)) + 
    geom_boxplot(fill = no_microbes_.22_color) +
    geom_jitter(alpha = 0.3, width = 0.05) +
    myCustomTheme() +
...
#ggsave("3a_RS.pdf", plot = fig_3a_RS, width = 3.46, height = 3.46)
