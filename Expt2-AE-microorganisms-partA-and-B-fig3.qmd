...
Question: Does the rate loss in Bd from day 1 to day 7 differ between the two filter types (40 and 0.22 um; aka AE microorganisms + and  AE microorganisms -)?
...
**Statistical question**: Is there a difference in the **rate of gain or loss of Bd over 6 days** between the **filter sizes** (looking at the TOTAL BD from each well)
